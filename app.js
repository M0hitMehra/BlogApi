...
app.get("/", (req, res) => {
  ...
  <div>
      <h1>Site is working click <a href=${process.env.FRONTEND_URL} style="color: blue; text-decoration: none;">here</a> to visit the website <span style="color: red; font-weight: bold;">CURRENTLY in DEVELOPMENT !!!!!!</span></h1>
      <div>
          <h1>API Routes</h1>
